...
/*
    Set the graph using adjency matrix and analize it using Dijkstra's algorithm for the shortest paths.
    by JL
    25.02.2021
*/
...
{        
    ...
    std::cout<<"\n------\nTITLE: Setting the graph using weighted adjency matrix and analizing it using Dijkstra's algorithm for the shortest path.\n\n";
    Analize_Graph(graph); 
}
